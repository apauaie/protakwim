...
-->
	...
	color: #148fce;opacity: 0.7;color:white; font-size:70px;" class="waktu-body"><?php echo $y; ?></div>
					...
					<div class="topright">
						 <div style="font-size:xx-large; font-family: itikaf;font-size: 4em;color: black"> <?php echo $masjidname.$test.$r.$l;?></div>

					</div>
			  
				   <div class="topright">
						 
						 <div id="normaldate" class="" style="text-align: right; font-size:xx-large; font-family: itikaf;font-size: 2em;color: black"> <?php echo $tarikhhariini;?></div>			 
						 
						 <div id="islamdate" class="" style="text-align: right;font-size:xx-large; font-family: itikaf;font-size: 2em;color: black"> <?php echo $todayhijrah;?></div>			 
						 
<!--                     	 <div  id="kawasan" class=""style="text-align: right;font-size:7em; font-family: itikaf;font-size: large;color: white"> <?php echo $kawasan;?></div>			  -->

 <div  id="time" hidden="" style="width:100px;align-content: flex-end; border-radius: 5px 35px;opacity:0.7;font-size:2em;font-weight: bold; margin:0;background-color: white;  font-family: itikaf;color: maroon"></div>
...
<div  id="iqomah" hidden="" style="align-self: right margin-bottom:30px;width : 80%;text-align: center;border-radius: 5px 35px;opacity:0.7;font-size:6em;font-weight: bold; margin:0;background-color: white;  font-family: itikaf;color: red;border-color:black;border-style: outset;border-bottom-width: thick;">00:00</div>		
<div  id="azantime" hidden="" style="align-self: right margin-bottom:30px;width : 80%;text-align: center;border-radius: 5px 35px;opacity:0.7;font-size:6em;font-weight: bold; margin:0;background-color: white;  font-family: itikaf;color: red;border-color:black;border-style: outset;border-bottom-width: thick;">00:00</div>		 
