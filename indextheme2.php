...
<head>
    ...
    <script type="text/javascript" src="plugin/snap.svg-min.js"></script>
...
<!--
                                <div style="background-color: #12e0cc;
    color: #148fce;opacity: 0.8;color:black;font-size:20px;" class="waktu-head"><?php echo $x; ?></div>
-->
                                <div style="font-family:itikaf;text-transform: capitalize; background-color:#17900c;
    color: #148fce;opacity: 0.75;color:yellow;font-size:20px;" class="waktu-body"><?php echo $x; ?></div>
    							 <div style="font-family:itikaf;background-color: #17900c;
    color: #148fce;opacity: 0.7;color:white; font-size:65px;" class="waktu-body"><?php echo $y; ?></div>
                    ...
                    <div class="topright">
                    	 <div style="font-size:xx-large; font-family: itikaf;font-size: xx-large;color: white"> <?echo $masjidname.$test.$r.$l;?></div>

                    </div>
              
                   <div class="topright">
                    	 
                    	 <div id="normaldate" class="" style="text-align: right; font-size:xx-large; font-family: itikaf;font-size: large;color: white"> <?echo $tarikhhariini;?></div>			 
                    	 
                    	 <div id="islamdate" class="" style="text-align: right;font-size:xx-large; font-family: itikaf;font-size: large;color: white"> <?echo $today;?></div>			 
                    	 
<!--                     	 <div  id="kawasan" class=""style="text-align: right;font-size:xx-large; font-family: itikaf;font-size: large;color: white"> <?echo $kawasan;?></div>			  -->

<!--  <div  id="time"  style="width:100px;align-content: flex-end; border-radius: 5px 35px;opacity:0.7;font-size:2em;font-weight: bold; margin:0;background-color: white;  font-family: itikaf;color: maroon"></div> -->
 <div class>
<svg version="1.1" id="clock" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	 width="650px" height="650px" viewBox="50 50 400 500" 
	 xml:space="preserve">
...
<!--
                    <div  class="rsidebar">
                                    <div id="time"  style="font-family:itikaf;  color:yellow;  font-size:7em;" class="waktu-body"></div>
	                     </div> 
-->  
<div  class="iqomah">
	
	<!--                     	  <div  id="kawasan" class="" style="text-align: center;font-size:xx-large; font-family: itikaf;font-size: xx-large;color: white">Azan</div> -->
	<div id="kawasan" hidden=""  class="kawasan" style="text-align: center;font-size:xx-large; font-family: itikaf;font-size: xx-large;color: white">Azan</div>
                    	 <div id="iqo" hidden=""  class="kawasan" style="text-align: center;font-size:xx-large; font-family: itikaf;font-size: xx-large;color: white">Iqomah</div>	
                    	 
                    	 
<div  id="iqomah" hidden="" style="align-self: right margin-bottom:30px;width : 80%;text-align: center;border-radius: 5px 35px;opacity:0.7;font-size:6em;font-weight: bold; margin:0;background-color: white;  font-family: itikaf;color: red;border-color:black;border-style: outset;border-bottom-width: thick;">34:34</div>		
<div  id="azantime" hidden="" style="align-self: right margin-bottom:30px;width : 80%;text-align: center;border-radius: 5px 35px;opacity:0.7;font-size:6em;font-weight: bold; margin:0;background-color: white;  font-family: itikaf;color: red;border-color:black;border-style: outset;border-bottom-width: thick;">34:34</div>		 
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title"> Kawasan dan Pesanan</h4>
                </div>
...
var timetime;
 ...
 $.ajax({
            url: "administrator/gettimerstatus.php?iqomah=0&azan=1",
...
/*
		function refresh(){
			 ...
			 $.ajax({
            url: "administrator/forcerefresh.php",
            success: function(data){}             
          });
...
// 	var iqomah= <?echo $iqomahperiod;?>;
     ...
     $.ajax({
            url: "administrator/gettimerstatus.php?iqomah=1&azan=0",
...
//     alert(iqo);
  ...
  .on('finish.countdown', function(event) {
    ...
    document.getElementById('iqo').style.display = 'none';
      ...
      window.open('administrator/solattime.php','_SELF');
    ...
    $( document ).ready(function() {
      ...
      setInterval(function() {
	      $.ajax({
            url: "administrator/getstatus.php",
            success: function(data){
                if (data=="yes"){ 
$.get("administrator/refreshstatusupdate.php");window.location.reload();}
             }
          });
