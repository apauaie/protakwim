...
-->
                                ...
                                <div class="clock-box">
                                    ...
                                    <div style="font-family: fantasy;font-size: 90px;" id="time" class="time"></div>
            ...
            <div class="container">
                <div class="row">
                    <?php foreach($waktuAzan as $x => $y): ?>
                        <div class="col-md-2">
                            <div class="panel panel-default">
                                <div class="panel-heading waktu-head"><?php $x= str_replace(" am","",$x);echo $x; ?></div>
                                <div style="font-size:30px;color:yellow;" class="panel-body waktu-body"><?php echo $y; ?></div>
                            </div>
                        </div>
                    <?php endforeach; ?>
                </div>
