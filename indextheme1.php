	                            ...
	                            <? foreach($ceramah as $row){?>
                                   ...
                                   <div class="item">
                                        <img class="slide-img" src="<?
	                                        if ($row['poster']!=""){
		                                        	                                        echo 'administrator/uploads/'.$row['poster'];
...
<!--
                                        <span data-toggle="modal"   data-target="">
                                            <button onclick="window.open('administrator/senarai_ceramah.php','_self')"  data-toggle="tooltip" title="Settings" data-placement="bottom" type="button" class="btn"><span class="glyphicon glyphicon-cog"></span></button>
                                        </span>
-->
                                    </div>
...
var fridayornot = todayday.getDay();
    	if ((fridayornot==5) && (waktunow=='zuhur')){
	    	window.open('administrator/solatjumaattime.php','_SELF');
    	}
