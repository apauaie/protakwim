...
global $DBH;
	...
	date_default_timezone_set('Asia/Kuala_Lumpur');
			  ...
			  if (isset($_POST['simpan']))   {
				  ...
				  $query = "UPDATE setting_list SET namamasjid='$namamasjid',pesanan='$pesanan',iqomahperiod='$iqomahperiod',timebeforeazan='$timebeforeazan',solatperiod='$solatperiod', scrollspeed=$scrollspeed, tema_id='$tema' WHERE id='1'";
	...
	$query2 ="SELECT  * FROM setting_list ";
                          ...
                          $tema_id= $setting[0][tema_id];
  
  $queryx ="SELECT  * FROM tema_list where id_tema='$tema_id'";
  
     
     $stmtx = $DBH->prepare($queryx);
     $queryx = $stmtx->execute();
     $resultx = $stmtx->fetchAll();
     $tema_picture=$resultx[0]['picture']; 
                  ...
                  <div class="x_content">
                    ...
                    <form method="post" class="form-horizontal form-label-left">
                      ...
                      <label class="control-label col-md-3 col-sm-3 col-xs-12">Tema</label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <select id=tema name='tema' class="form-select" aria-label="Default select example">
                            <?php foreach ($result2 as $row){
                              if ($row['id_tema']==$tema_id) $s="selected"; else $s="";
                              echo "<option ".$s." value=".$row['id_tema'].">".$row['nama_tema']."</option>";
                            }?>
                      ...
                      <div class="form-group">
                        <div align=right class="col-md-9 col-sm-9 col-xs-12">
                       <img src="uploads/<?php echo $tema_picture;?>" alt="Tema" width="500" height="300">
                        </div>
                      </div>
