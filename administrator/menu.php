            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                <ul class="nav side-menu">
                  ...
                  <li><a href=password_change.php><i class="fa fa-key"></i> Tukar Kata Laluan </a></li>
                  <li><a href=password_protect.php?logout><i class="fa fa-sign-out"></i> Logout </a></li>
              ...
              <ul class="nav navbar-nav navbar-right">
                ...
                <li role="presentation" class="dropdown">
                  <a href="javascript:;" class="dropdown-toggle info-number" data-toggle="dropdown" aria-expanded="false">
                    ...
                    <span class="badge bg-green"><?echo $_SERVER['SERVER_ADDR'];?></span>
                  </a>
