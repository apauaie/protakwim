...
<?php include ('../password_protect.php');
 ...
 $DBH->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
	...
	date_default_timezone_set('Asia/Kuala_Lumpur');
                          ...
                          $timeperimage= $_POST['timeperimage'];
                          
                          $timeprayerdisplay= $_POST['timeprayerdisplay'];
			                    
			                    
			  if (isset($_POST['simpan']))   {
				  
				  $query = "UPDATE setting_list SET namamasjid='$namamasjid',pesanan='$pesanan',iqomahperiod='$iqomahperiod',timebeforeazan='$timebeforeazan',solatperiod='$solatperiod', scrollspeed=$scrollspeed,time_per_image=$timeperimage,timeprayerdisplay=$timeprayerdisplay WHERE id='1'";
	...
	$query2 ="SELECT  * FROM setting_list ";
			                    ...
			                    $timeperimages=$setting[0]['time_per_image'];
                          $timeprayerdisplays= $setting[0]['timeprayerdisplay'];
                  ...
                  <div class="x_content">
                    ...
                    <form method="post" class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        ...
                        <label class="control-label col-md-3 col-sm-3 col-xs-3">Menunggu Iqomah (minit)</label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input id="iqomahperiod" required="required" class="form-control" value="<?php echo $iqomahperiod/1000/60;?>" name="iqomahperiod"/>
                        </div>
                      ...
                      <div class="form-group">
					   ...
					   <label class="control-label col-md-3 col-sm-3 col-xs-3">Azan(minit)</label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input id="timebeforeazan" required="required" class="form-control" value="<?php echo $timebeforeazan/1000/60;?>" name="timebeforeazan"/>
                        </div>
                      </div>
                      
                      <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-3">Masa Solat(minit)</label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input id="solatperiod" required="required" class="form-control" value="<?php echo $solatperiod/1000/60;?>" name="solatperiod"/>
                        </div>
                      </div>
                      
                      <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-3">Masa Satu Gambar (saat)</label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input id="timeperimage" required="required" class="form-control" value="<?php echo $timeperimages;?>" name="timeperimage"/>
                        </div>
                      </div>
                      
                      <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-3">Masa Paparan Jam Solat (saat)</label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input id="timeprayerdisplay" required="required" class="form-control" value="<?php echo $timeprayerdisplays;?>" name="timeprayerdisplay"/>
                        </div>
                      </div>
                     
                      
                      <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-3">Laju Skrol Pesanan (saat)</label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input id="scrollspeed" required="required" class="form-control" value="<?php echo $scrollspeed;?>" name="scrollspeed"/>
                        </div>
                      </div>
					   ...
					   <label class="control-label col-md-3 col-sm-3 col-xs-12">Pesanan</label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <textarea rows="5" id="pesanan" required="required" class="form-control" name="pesanan"  data-parsley-trigger="keyup"  data-parsley-maxlength="300" data-parsley-minlength-message=""
                            data-parsley-validation-threshold="10"><?php echo $pesanan;?></textarea>
                        </div>
                      </div>
<!--
                        <div class="form-group">
