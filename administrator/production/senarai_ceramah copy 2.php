...
<!--                                 <a href="#"><i class="fa fa-pencil"></i></a> -->
                                ...
                                <div class="pull-right">
                                        <span data-toggle="modal" data-target="#myModal_<?echo $t;?>">
 ...
 <!-- Modal -->
    <div id="myModal_<?echo $t;?>" name="myModal_<?echo $t;?>" class="modal fade" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-body">
                <form id=save_form method="POST" action="modalsave.php">
	                <input hidden type=text value = '<?echo $row['id'];?>' name="idi" id=idi>
                   <label for="email">Tajuk Program :</label>
                      ...
                      <input type="text" id="penceramah" class="form-control" value='<?echo $row['penceramah'];?>' name="penceramah" />
                    ...
                    <div class="form-group">
                        <div class='input-group date' id='myDatepicker'>
                            <input required type='text' name="tarikhceramah" id=tarikhceramah value='<?echo $row['tarikh'];?>' class="form-control" />
                    ...
                    <div class="form-group">
                        <div class='input-group date' id='myTimepicker'>
                            <input type='text' name="masaceramah" id=masaceramah value='<?echo $row['masa'];?>' class="form-control" />
                            <span class="input-group-addon">
                               <span class="glyphicon glyphicon-calendar"></span>
                            </span>
                        </div>
            ...
            <div class="modal-footer">
                <button id=save nama="save"  data-target="#myModal_<?echo $t;?>" type="button" class="btn btn-default" data-dismiss="modal">Simpan</button>
            </div>
            </div>
        </div>
    </div>
