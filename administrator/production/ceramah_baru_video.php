<?php 
 ...
 $DBH->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
	...
	$displaytext=$_POST['textstatus'];
		  ...
		  $query ="INSERT INTO `ceramah_list_video`(`penceramah`, `tajuk`, `lokasi`, `tarikh`, `masa`, `modifiedby`, `status`, `remarks`, `displaytext`) VALUES (:penceramah,:tajuk,:lokasi,:tarikhceramah,:masaceramah,:modifiedby,:status,:remarks,:displaytext)";
...
//          echo "Success";
          $query = "UPDATE ceramah_list_video SET displaytext='off' , poster='$file_name' WHERE id='$lastid'";
			$statement = $DBH->prepare($query);
			$statement->execute();
...
window.location.href = 'senarai_ceramah_video.php';
