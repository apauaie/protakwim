          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Aktiviti <small>  di Masjid Pulai Indah </small></h2>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Tatapan Program</h4>
                </div>
            ...
            <div class="modal-footer">
                <button nama=save type="button" class="btn btn-default" data-dismiss="modal">Simpan</button>
            </div>
            </div>
        </div>
    </div>
